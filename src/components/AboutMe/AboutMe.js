  ...
  return (
    <div className="wrapper">
      <div class="aboutme-container">
        ...
        <div data-aos="fade-left" class="about-text go-to">
          <h3 class="dark-color">About Me</h3>
          <h6 class="theme-color lead">A Full Stack Web-Developer based in Germany</h6>
          <p> My programming journey began 3 years ago when I learned how to program and execute different alarm systems.To go further, I decided to dive into web development in 2020. The passion and motivation, I'm attaining for this industry, are allowing me to enjoy every minute of it and driving me to learn more every day. I'm looking forward to joining a new team of motivated individuals, to demonstrate my gained skills and abilities.</p>
        </div>
      </div>
    </div>
